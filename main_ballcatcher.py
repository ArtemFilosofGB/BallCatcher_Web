...
#Start menu
# start_menu_img = py.image.load(img_path + "img/start_menu.png").convert_alpha()
# start_menu_img = py.transform.scale(start_menu_img, (WIDTH//2 , HEIGHT//2))
# start_menu_img_rect = start_menu_img.get_rect()
#
# button1_img = py.image.load(img_path + "img/button1.png").convert_alpha()
# button1_img = py.transform.scale(button1_img, (WIDTH//2-100 , 100))
# button1_img_rect = button1_img.get_rect()
#
# button2_img = py.image.load(img_path + "img/button2.png").convert_alpha()
# button2_img = py.transform.scale(button2_img, (WIDTH//2-100 , 100))
# button2_img_rect = button2_img.get_rect()
#
# button3_img= py.image.load(img_path + "img/button3.png").convert_alpha()
# button3_img = py.transform.scale(button3_img, (WIDTH//2-100 , 100))
# button3_img_rect = button3_img.get_rect()
#
# screen.blit(start_menu_img, (100, 100))
# button1_img_rect = button1_img.get_rect(center=(WIDTH // 2, HEIGHT // 2 + 100))
# button2_img_rect = button2_img.get_rect(center=(WIDTH // 2, HEIGHT // 2 + 200))
# button3_img_rect = button3_img.get_rect(center=(WIDTH // 2, HEIGHT // 2 + 300))
...
def game_start():
    ...
    global game_start_fl
    print("in Game start menu")


    screen.blit(button1_img, (100, 100))
    screen.blit(button2_img, (100, 200))
    screen.blit(button3_img, (100, 300))
    py.display.update()

    while not game_start_fl:
        for event in py.event.get():
            if event.type == py.MOUSEBUTTONDOWN:
                if button1_img_rect.collidepoint(py.mouse.get_pos()):
                    game_start_fl = True
                    print("Button1 - Game start")
                if button2_img_rect.collidepoint(py.mouse.get_pos()):
                    game_start_fl = True
                    print("Button2 - Game start")
                if button3_img_rect.collidepoint(py.mouse.get_pos()):
                    print("Button3 - Exit")
                    exit()
...
async def main():
    ...
    while True:
        ...
        # if game_start_fl==False:
        #     game_start() # start menu
